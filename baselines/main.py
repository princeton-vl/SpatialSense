...
def train(model, criterion, optimizer, loader, epoch, args):
    ...
    for idx, data_batch in enumerate(loader):
        ...
        if args.model == 'drnet':
            ...
            output = model(subj_batch_var, obj_batch_var, img, mask_batch_var, predicate)
            ...
            output = model(subj_batch_var, obj_batch_var, img, ts_batch_var, to_batch_var, bboxs_batch_var, bboxo_batch_var, predicate)
