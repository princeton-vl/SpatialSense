...
parser.add_argument('--num', type=int, default=10, help='The number of relations to visualize')
parser.add_argument('--dataroot', default='.', help='The directory where annotation.js and images reside')
parser.add_argument('--output', default='./visualizations', help='The directory to output visualizations')
...
for i, rel in enumerate(relations):
    ...
    s = '%s-%s-%s    %s' % (rel['subject']['name'], rel['predicate'], rel['object']['name'], str(rel['label']))
